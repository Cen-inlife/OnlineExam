...
<%@page import="com.clh.online.exam.service.impl.CourseInfoServiceImpl"%>
<%@page import="com.clh.online.exam.po.CourseInfo"%>
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" action="../autoAddSubject">
						...
						<div class="form-group">
							<%--@declare id="class"--%><label for="class" class="col-sm-2 control-label">科目</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							 <%--@declare id="grade"--%><label for="grade" class="col-sm-2 control-label">年级</label>
							<div class="col-sm-10">
